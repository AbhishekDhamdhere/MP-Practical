...
s1: mov al,[rsi]   
mov [rdi],al       ;it will read the content pointed by rsi and put it in al
inc rsi            
inc rdi
loop s1           ;loop until counter not 0

print msg2,msg2len
mov rsi,dstblk
call disp_block   ;it will print the destionation block
